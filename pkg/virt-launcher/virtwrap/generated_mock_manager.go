...
func (_m *MockDomainManager) GetInterfaceStatus() []api.InterfaceStatus {
	ret := _m.ctrl.Call(_m, "GetInterfaceStatus")
	ret0, _ := ret[0].([]api.InterfaceStatus)
	return ret0
}

func (_mr *_MockDomainManagerRecorder) GetInterfaceStatus() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetInterfaceStatus")
}
