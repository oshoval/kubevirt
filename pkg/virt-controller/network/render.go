...
func GetNetworkAttachmentDefinitionByName(k8sCniCncfIoV1 k8scnicncfiov1.K8sCniCncfIoV1Interface, namespace string, multusNetworks []virtv1.Network) (map[string]*networkv1.NetworkAttachmentDefinition, error) {
