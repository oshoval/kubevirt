...
func (m *IPAMClaimsManager) CreateIPAMClaims(namespace string, vmiName string, interfaces []virtv1.Interface, networks []virtv1.Network, ownerRef *v1.OwnerReference) error {
	...
	if err := m.createIPAMClaims(namespace, claims); err != nil {
...
func composeIPAMClaims(namespace string, ownerRef *v1.OwnerReference, networkToIPAMClaimParams map[string]ipct.IPAMClaimParams) []*ipamclaims.IPAMClaim {
...
func composeIPAMClaim(namespace string, ownerRef v1.OwnerReference, ipamClaimParams ipct.IPAMClaimParams, interfaceName string) *ipamclaims.IPAMClaim {
...
func (m *IPAMClaimsManager) GetNetworkToIPAMClaimParams(namespace string, vmiName string, multusNonDefaultNetworks []virtv1.Network) (map[string]ipct.IPAMClaimParams, error) {
...
func ExtractNetworkToIPAMClaimParams(nadMap map[string]*networkv1.NetworkAttachmentDefinition, vmiName string) (map[string]ipct.IPAMClaimParams, error) {
	...
	for networkName, nad := range nadMap {
		...
		if persistentIPsNetworkName != "" {
			networkToIPAMClaimParams[networkName] = ipct.IPAMClaimParams{
