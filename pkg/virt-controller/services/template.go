...
func generatePodAnnotations(vmi *v1.VirtualMachineInstance, networkToIPAMClaimParams map[string]ipct.IPAMClaimParams, config *virtconfig.ClusterConfig) (map[string]string, error) {
